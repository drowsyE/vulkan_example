...
void Renderer::createGraphicsPipeline() {
  ...
  // ----------- shader -----------
  VkShaderModule vertexShaderModule = createShader("2dGravitySimulation/shader/vert.spv");
  VkShaderModule fragShaderModule = createShader("2dGravitySimulation/shader/frag.spv");
